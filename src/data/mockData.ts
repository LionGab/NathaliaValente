...
export const mockComments = [
  ...
  },
  {
    ...
    user_id: '3',
    content:
      'Essa dica mudou minha vida! Agora tenho uma meta clara para minha reserva. Obrigada! 🙏',
...
export const mockDailyQuotes = [
  {
    id: '1',
    quote:
      'A maternidade é uma jornada de autoconhecimento. Cada desafio nos torna mais fortes e cada conquista nos aproxima da mulher que sempre fomos destinadas a ser.',
  ...
  },
  {
    id: '2',
    quote:
      'Ser mãe não significa perder sua identidade. É descobrir uma versão ainda mais poderosa de quem você já é.',
    author: 'Nathália Valente',
    category: 'Educação',
