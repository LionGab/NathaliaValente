...
export const products: Product[] = [
    // NAVA Products
    {
        ...
        discount: 30,
        images: [
            '/images/products/nava/nava-bikini-premium.jpg',
    ...
    },
    {
        ...
        discount: 20,
        images: [
            '/images/products/nava/nava-legging-yoga.jpg',
    ...
    {
        id: 'nava-zebra-bikini',
        name: 'Bikini Zebra Print',
        brand: 'NAVA',
        category: 'bikinis',
        price: 95.90,
        images: [
            '/images/products/nava/nava-zebra-bikini.jpg',
            '/images/products/heroes/mother-baby-hero-3.jpg'
        ],
        description: 'Bikini com estampa zebra exclusiva. Design ousado e elegante, perfeito para quem quer se destacar na praia. Tecido de alta qualidade e modelagem que valoriza o corpo.',
        sizes: ['P', 'M', 'G', 'GG'],
        colors: ['Zebra Preto', 'Zebra Rosa'],
        inStock: true,
        rating: 4.6,
        reviews: 156,
        tags: ['zebra', 'estampa', 'ousado', 'praia'],
