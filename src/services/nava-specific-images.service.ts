...
export class NavaSpecificImagesService {
  private static readonly FALLBACK_BASE_URL =
    'https://via.placeholder.com/400x600/FF69B4/FFFFFF?text=NAVA+';
  ...
  private static readonly NAVA_SPECIFIC_IMAGES: NavaSpecificImage[] = [
    {
      ...
      description:
        'Conjunto Biquíni Nathy - Zebra com Preto sem Bojo com Alças Ajustáveis e Forro Macio em Poliamida para Praia e Piscina',
      price: 'R$ 165,00',
      paymentInfo: '2x de R$ 82,50 sem juros',
      category: 'bikinis',
      model: 'Mulher com cabelos ruivos, sentada em cadeira de vime com almofadas listradas',
      features: [
        'Estampa zebra preta e branca',
        'Top halter triangular',
        'Alças finas pretas',
        'Fecho metálico na frente',
        'Fio dental com tiras finas pretas',
      ],
    },
    {
      ...
      description:
        'Conjunto Biquíni Nathy - Onça com preto sem Bojo com Alças Ajustáveis e Forro Macio em Poliamida para Praia e Piscina',
      price: 'R$ 165,00',
      paymentInfo: '2x de R$ 82,50 sem juros',
      category: 'bikinis',
      model: 'Mulher com pele bronzeada, close-up do torso com piercing dérmico',
      features: [
        'Estampa oncinha em tons de marrom e preto',
        'Top halter triangular',
        'Alças finas pretas',
        'Piercing dérmico no centro do peito',
        'Tatuagem de lótus',
      ],
    },
    {
      ...
      description:
        'Conjunto Biquíni Nathy - Zebra com Rosa sem Bojo com Alças Ajustáveis e Forro Macio em Poliamida para Praia e Piscina',
      price: 'R$ 165,00',
      paymentInfo: '2x de R$ 82,50 sem juros',
      category: 'bikinis',
      ...
      features: [
        ...
        'Top halter triangular',
        'Fio dental',
        'Tatuagem de escorpião na coxa direita',
      ],
    },
    {
      ...
      description:
        'Conjunto Biquíni Nathy - Todo Branco sem Bojo com Alças Ajustáveis e Forro Macio em Poliamida para Praia e Piscina',
      price: 'R$ 165,00',
      paymentInfo: '2x de R$ 82,50 sem juros',
      category: 'bikinis',
      model: 'Mulher com cabelos ruivos tirando selfie no espelho',
      features: [
        'Biquíni branco de duas peças',
        'Top halter triangular',
        'Piercing dérmico no centro do peito',
        'Colar de contas brancas finas',
        'Tatuagens no braço esquerdo e torso',
      ],
    },
    {
