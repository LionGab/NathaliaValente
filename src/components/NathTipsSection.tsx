      ...
      <div className="space-y-4">
        ...
        {showFilters && (
          <div className="grid md:grid-cols-2 gap-4 p-4 bg-neutral-50 dark:bg-neutral-800 rounded-xl">
            {/* Categorias */}
            <div>
              <h3 className="font-semibold text-neutral-900 dark:text-white mb-3">Categorias</h3>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-8 border-t border-neutral-200 dark:border-neutral-700">
          ...
          <div className="text-center">
            <div className="text-2xl font-bold text-purple-500">
              {Object.keys(tipCategories).length}
            </div>
      ...
      <div className={`p-6 bg-gradient-to-r ${categoryInfo.color}`}>
        <div className="flex items-start justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-xl font-bold text-neutral-900 dark:text-white">{tip.title}</h3>
              <p className="text-sm text-neutral-600 dark:text-neutral-400">{categoryInfo.name}</p>
            </div>
          </div>
          <button
        ...
        <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed">{tip.summary}</p>
