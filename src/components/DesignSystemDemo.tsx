...
export const DesignSystemDemo: React.FC = () => {
        ...
        <div className="flex flex-wrap gap-2">
          {[50, 100, 200, 300, 400, 500, 600, 700, 800, 900, 950].map((shade) => (
            <div key={shade} className="flex flex-col items-center">
              ...
              />
              <span className="text-xs text-neutral-600 dark:text-neutral-400 mt-1">{shade}</span>
            </div>
          ))}
        </div>
      </div>
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="space-y-2">
          <h1 className="text-4xl font-bold text-primary-600 dark:text-primary-400">Display 2XL</h1>
          <h2 className="text-3xl font-bold text-primary-600 dark:text-primary-400">Display XL</h2>
      ...
      <div>
        ...
        <div className="space-y-2">
          <h1 className="text-2xl font-bold text-neutral-900 dark:text-neutral-100">Heading 1</h1>
  ...
  const ComponentsDemo = () => (
    <div className="space-y-6">
      ...
      {/* Cards */}
      <div>
        <h3 className="text-lg font-semibold text-neutral-800 dark:text-neutral-200 mb-3">Cards</h3>
        <div className="space-y-3">
          ...
          <div className="bg-gradient-to-r from-primary-500 to-secondary-500 p-4 rounded-xl shadow-medium">
            <h4 className="font-semibold text-white mb-2">Gradient Card</h4>
      ...
      {/* Icons */}
      <div>
        <h3 className="text-lg font-semibold text-neutral-800 dark:text-neutral-200 mb-3">Icons</h3>
        <div className="flex flex-wrap gap-4">
          <div className="flex flex-col items-center">
            <div className="w-12 h-12 bg-primary-100 dark:bg-primary-900 rounded-full flex items-center justify-center">
              <Heart className="w-6 h-6 text-primary-600 dark:text-primary-400" />
            </div>
            <span className="text-xs text-neutral-600 dark:text-neutral-400 mt-1">Heart</span>
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <span className="text-xs text-neutral-600 dark:text-neutral-400 mt-1">Star</span>
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <span className="text-xs text-neutral-600 dark:text-neutral-400 mt-1">Sparkles</span>
          </div>
        </div>
      </div>
    </div>
