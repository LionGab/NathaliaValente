...
export const MealPlanner: React.FC = () => {
    ...
    const getMealTypeColor = (type: string) => {
        switch (type) {
            ...
            case 'lunch': return 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-300';
            case 'dinner': return 'bg-purple-100 text-purple-700 dark:bg-purple-900/30 dark:text-purple-300';
            case 'snack': return 'bg-yellow-100 text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-300';
            ...
            <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400">
                        Organize as refeições da semana
                    </p>
                </div>
            </div>
            ...
            {getShoppingList().length > 0 && (
                <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-4 mb-6">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                        {getShoppingList().slice(0, 8).map((item, index) => (
                            <div key={index} className="flex items-center justify-between bg-white dark:bg-gray-700 rounded-lg p-2">
                                ...
                                {day.meals.map((meal) => (
                                    <div key={meal.id} className="bg-gray-50 dark:bg-gray-700 rounded-lg p-3">
                                        ...
                                        <div className="flex items-center gap-4 text-xs text-gray-500 dark:text-gray-400">
                                            ...
                                            <div className={`flex items-center gap-1 ${getDifficultyColor(meal.difficulty)}`}>
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => setNewMeal(prev => ({ ...prev, prepTime: Number(e.target.value) }))}
                                        className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                                    />
                                </div>
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => setNewMeal(prev => ({ ...prev, servings: Number(e.target.value) }))}
                                        className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                                    />
                                </div>
                            </div>
