              ...
              >
                {isActive && (
                  <motion.div
                    ...
                    className="absolute inset-0 bg-gradient-to-t from-pink-50 to-purple-50 dark:from-pink-500/10 dark:to-purple-500/10 rounded-xl sm:rounded-2xl"
                ...
                >
                  ...
                  {item.badge && (
                    <motion.div
                      ...
                      className="absolute -top-1 -right-1 bg-gradient-to-r from-pink-500 to-purple-600 text-white text-xs font-bold px-1.5 py-0.5 rounded-full shadow-lg"
                    >
                      {item.badge}
                    </motion.div>
                  )}
                ...
                {isActive && (
                  <motion.div
                    ...
                    className="absolute -top-1 left-1/2 transform -translate-x-1/2 w-1 h-1 bg-pink-500 rounded-full"
                    transition={{ type: 'spring', bounce: 0.2, duration: 0.6 }}
                  />
                )}
              </motion.button>
