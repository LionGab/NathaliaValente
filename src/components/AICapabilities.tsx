...
const capabilities: AICapability[] = [
  ...
  },
  {
    ...
    examples: ['Yoga para gestantes', 'Exercícios pós-parto', 'Atividades com o bebê'],
  },
  {
    id: 'sleep',
    title: 'Dicas de Sono',
    ...
    <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-200 dark:border-gray-700">
            ...
            >
              <div className="flex items-start justify-between mb-3">
                <div className="flex items-center gap-3">
                  <div
                    className={`w-10 h-10 bg-gradient-to-r ${capability.color} rounded-lg flex items-center justify-center`}
                  >
      ...
      <div className="mt-6 p-4 bg-gradient-to-r from-green-50 to-blue-50 dark:from-green-900/20 dark:to-blue-900/20 rounded-xl border border-green-200 dark:border-green-700">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h4 className="font-semibold text-gray-800 dark:text-white text-sm">NathIA Ativa</h4>
            <p className="text-xs text-gray-600 dark:text-gray-400">
