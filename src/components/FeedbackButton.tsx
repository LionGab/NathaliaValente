...
export const FeedbackButton: React.FC<FeedbackButtonProps> = ({ userWeek = 0, userId }) => {
            ...
            >
              {!submitted ? (
                <>
                  ...
                  <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center gap-3">
                      ...
                      <h3 className="text-xl font-bold text-gray-800">Sua opinião importa! 💗</h3>
                    </div>
                    <button
                  ...
                  <div className="mb-6">
                    ...
                    <textarea
                      ...
                      maxLength={500}
                    />
                    <p className="text-xs text-gray-500 mt-1">{feedback.length}/500 caracteres</p>
                  </div>
                ...
                >
                  ...
                  <h3 className="text-xl font-bold text-gray-800 mb-2">Obrigada! 💗</h3>
                  <p className="text-gray-600">
                    Seu feedback é muito importante para nós. Vamos usar sua sugestão para melhorar
                    o app!
                  </p>
                </motion.div>
              )}
