    ...
    <div className="text-center space-y-4 sm:space-y-6">
      ...
      >
        <motion.button
          ...
          className={`group relative w-full py-3 sm:py-4 px-6 rounded-2xl font-bold text-sm sm:text-base transition-all duration-300 overflow-hidden min-h-[48px] ${
            selectedState
          ...
          aria-label={
            selectedState
              ...
              : 'Selecione um estado emocional para continuar'
          }
