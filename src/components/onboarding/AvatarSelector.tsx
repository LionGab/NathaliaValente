...
const avatarCategories = {
  'Estados Emocionais': [
    { type: 'exausta' as AvatarType, label: 'Exausta', description: 'Para quando você está cansada' },
    ...
    { type: 'vulneravel' as AvatarType, label: 'Vulnerável', description: 'Para momentos difíceis' },
  ...
  'Diversidade': [
    { type: 'hijab' as AvatarType, label: 'Com Hijab', description: 'Representatividade muçulmana' },
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            Olá, {userName}! Escolha um avatar que represente você e sua jornada como mãe. 
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400">
                      Este avatar representa você no ClubNath. Você pode mudá-lo a qualquer momento nas configurações.
                    </p>
                  </div>
                </div>
                ...
                <Button
                  ...
                  leftIcon={isCompleting ? <LoadingSpinner size="sm" /> : <ArrowRight className="w-4 h-4" />}
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-pink-800 dark:text-pink-300">
                Seus avatares representam diferentes momentos da sua jornada como mãe. 
                Escolha aquele que mais se conecta com você agora, ou que representa como você gostaria de se sentir!
              </p>
            </div>
          </div>
        </div>
