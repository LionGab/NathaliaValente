...
export const FEMININE_ARCHETYPES: ArchetypeOption[] = [
  {
    ...
    audioIntro:
      'Você escolheu a Mãe Guerreira. Aqui, aprenderemos a lutar com amor, sem perder a ternura.',
    color: 'from-error-50 to-primary-100',
  ...
  },
  {
    ...
    audioIntro:
      'Você escolheu a Mãe Resiliente. Aqui, descobriremos como transformar dificuldades em sabedoria materna.',
