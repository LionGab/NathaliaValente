    ...
    <div className="max-w-6xl mx-auto px-4 py-6">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
          Recursos reais para te ajudar no dia a dia da maternidade. Organize, acompanhe e cuide de
          você e do seu bebê.
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        {quickStats.map((stat, index) => (
          ...
          >
            <div
              className={`w-12 h-12 mx-auto mb-3 rounded-xl flex items-center justify-center ${stat.color.replace('text-', 'bg-').replace('dark:text-', 'dark:bg-')} bg-opacity-10`}
            >
          ...
          >
            <div className="flex items-start gap-4">
              <div className={`p-4 rounded-xl ${tool.bgColor}`}>
                <tool.icon
                  className={`w-8 h-8 bg-gradient-to-r ${tool.color} bg-clip-text text-transparent`}
                />
              </div>
      ...
      <div className="mt-12 bg-gray-50 dark:bg-gray-700 rounded-2xl p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-800 dark:text-white mb-2">Bem-estar</h3>
            <p className="text-gray-600 dark:text-gray-400">
      ...
      <div className="mt-8 text-center">
        <div className="bg-gradient-to-r from-pink-500 to-purple-600 rounded-2xl p-8 text-white">
          <h3 className="text-2xl font-bold mb-4">Pronta para transformar sua rotina?</h3>
