                    ...
                    {todayRoutines.length === 0 ? (
                        ...
                        todayRoutines.map((routine, index) => (
                            <motion.div
                                ...
                                className={`flex items-center gap-3 p-3 rounded-xl transition-all duration-300 ${routine.completed_at
                            ...
                            >
                                ...
                                <button
                                    ...
                                    className={`w-6 h-6 rounded-full border-2 flex items-center justify-center transition-all duration-200 hover:scale-110 ${routine.completed_at
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <h4 className={`font-semibold text-sm ${routine.completed_at
