...
const HomePageSimple = () => {
  ...
  const quickActions = [
    ...
    return (
        ...
        {/* Desapega das Mamães - Produtos Usados */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          ...
          className="mb-6"
        >
          <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl p-4 shadow-lg border border-green-100">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Produtos usados em excelente estado
                </p>
              </div>
            </div>
            
            {/* Grid de produtos usados */}
            ...
            <button className="w-full mt-4 bg-green-600 text-white py-3 rounded-xl font-semibold text-sm hover:bg-green-700 transition-colors">
              Ver todos os desapegos
            </button>
          </div>
        </motion.div>
