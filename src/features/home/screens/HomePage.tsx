...
const HomePage = () => {
  ...
  const { stats, tasks, completeTask, getProgressPercentage, getLevelProgress, getBadgeInfo } =
    useUserStats();
  const [showCreatePost, setShowCreatePost] = useState(false);
  const [showCelebration, setShowCelebration] = useState(false);
  const [celebrationType, setCelebrationType] = useState<
    'streak' | 'task_complete' | 'level_up' | 'badge_earned'
  >('task_complete');
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600 dark:text-gray-400">Cronômetro e dicas</p>
                </div>
              </div>
            </button>
            ...
            >
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600 dark:text-gray-400">Acompanhe cochilos</p>
                </div>
              </div>
            </button>
            ...
            >
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  <h3 className="font-semibold text-gray-800 dark:text-white text-sm">Refeições</h3>
                  <p className="text-xs text-gray-600 dark:text-gray-400">Planeje o cardápio</p>
                </div>
              </div>
            </button>
            ...
            >
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  <h3 className="font-semibold text-gray-800 dark:text-white text-sm">Bem-estar</h3>
                  <p className="text-xs text-gray-600 dark:text-gray-400">Cuide de você</p>
                </div>
              </div>
            </button>
          </div>
        ...
        >
          <div className="bg-gradient-to-br from-pink-50 to-purple-50 dark:from-pink-900/20 dark:to-purple-900/20 rounded-3xl p-6 border border-pink-200 dark:border-pink-800 shadow-lg">
            ...
            <blockquote className="text-gray-700 dark:text-gray-300 leading-relaxed text-lg font-medium italic">
              "Lembre-se: você não precisa ser perfeita, apenas presente. Cada pequeno gesto de amor
