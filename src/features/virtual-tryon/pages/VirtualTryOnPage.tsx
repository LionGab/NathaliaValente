            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {products.map((product) => (
                    <div
                        ...
                        className={`p-4 border-2 rounded-lg cursor-pointer transition-colors ${selectedProduct?.id === product.id
                    ...
                    <div className="flex gap-2">
                        {selectedProduct.colors.map((color) => (
                            <button
                                ...
                                className={`px-3 py-2 border rounded-lg text-sm font-medium transition-colors ${selectedColor === color
                                        ? 'border-pink-500 bg-pink-500 text-white'
                                        : 'border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:border-gray-400'
                                    }`}
                            >
                ...
                <div className="mb-4">
                    ...
                    <div className="flex items-center gap-4">
                        <div className="text-center">
                            <div className={`text-2xl font-bold ${tryOnResult.fit_analysis.overall_fit === 'perfect' ? 'text-green-600' :
